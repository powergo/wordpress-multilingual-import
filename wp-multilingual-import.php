...
define('DEFAULT_ID_META', 'id');
define('DEFAULT_LANGUAGE_META', 'language');
...
function post_saved($id) {
    ...
    if (defined('WP_ALL_IMPORT_WPML_LANGUAGE_META') && WP_ALL_IMPORT_WPML_LANGUAGE_META) {
        ...
        $language_meta_field = DEFAULT_LANGUAGE_META;
    }
    ...
    if ($language == $default_language) {
        // Already in default language so nothing to do.
        return;
    }
